...
private val retrofit = Retrofit.Builder().baseUrl("https://firebasestorage.googleapis.com/")
...
interface DatabaseApiService{
    @GET("v0/b/tourism-3aef0.appspot.com/o/Cultoura%20database.json?alt=media&token=7ee941a8-439a-44eb-b578-5e036f84beff")
